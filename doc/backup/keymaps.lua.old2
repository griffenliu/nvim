...
_M.setup = function()
    ...
    -- windows 分屏快捷键
    set("n", "<leader>ww", ":vsp<CR>", "[窗口] 垂直分屏")
    set("n", "<leader>wh", ":sp<CR>", "[窗口] 水平分屏")
    -- set("n", "<C-=>", ":sp<CR> :vsp<CR>", "四分屏")
    -- 关闭当前窗口
    set("n", "<leader>wc", ":close<CR>", "[窗口] 关闭当前窗口")
    -- 关闭其他窗口
    set("n", "<leader>wo", ":only<CR>", "[窗口] 关闭其他窗口")

    -- 等比例
    set("n", "<leader>w=", "<C-w>=", "[窗口] 等比例分割窗口")
    -- 左右比例控制
    ...
    set("n", "<leader>ss", ":e $MYVIMRC | :cd %:p:h | split . | wincmd k | pwd<CR>", "设置")
