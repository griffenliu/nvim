...
local function theme_config()
    ...
    -- Set menu
    dashboard.section.buttons.val = {dashboard.button("f", "  > Find file", ":cd $HOME/ | Telescope find_files<CR>"),
...
local _M = base.new {
    ...
    packer = {
        'goolord/alpha-nvim',
        config = function()
            require("plugins.tools.dashboard"):config()
        end
    }
}
setmetatable(_M, {
